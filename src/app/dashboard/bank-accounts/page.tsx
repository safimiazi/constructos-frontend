...
import { CURRENCY_OPTIONS } from '@/hooks/use-select-options';
      ...
      {showForm && (
        <div className="card p-5">
          <form onSubmit={e => { e.preventDefault(); create.mutate({ ...form, balance: Number(form.balance) }); }} className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <Select options={CURRENCY_OPTIONS} value={form.currency} onChange={v => setForm(p => ({ ...p, currency: v }))} placeholder="Currency" label="Currency" searchable={false} />
